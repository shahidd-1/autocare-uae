...
export default function BeforeAfter(){
 ...
 return <section className="py-20 md:py-28 px-5 md:px-8">
  <div className="max-w-7xl mx-auto">
   <div className="flex items-end justify-between mb-8"><div><div className="text-[10px] tracking-[.3em] text-[#854F6C] mb-4">05 / THE DIFFERENCE</div><h2 className="font-display text-4xl md:text-6xl font-extrabold tracking-[-.05em]">SEE THE <span className="text-gradient">DIFFERENCE.</span></h2></div><div className="hidden md:block text-xs text-[#854F6C]">DRAG TO COMPARE</div></div>
   <div ref={ref} onMouseMove={e=>e.buttons===1&&move(e.clientX)} onTouchMove={e=>move(e.touches[0].clientX)} className="relative h-[420px] md:h-[620px] rounded-[2rem] overflow-hidden select-none cursor-ew-resize glass">
    ...
    <div className="absolute top-5 left-5 glass rounded-full px-4 py-2 text-[10px] tracking-[.2em]">BEFORE</div><div className="absolute top-5 right-5 glass rounded-full px-4 py-2 text-[10px] tracking-[.2em]">AFTER</div>
